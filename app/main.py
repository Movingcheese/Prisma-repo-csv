...
def login_to_prisma_cloud(api_url, access_key, secret_key):
...
def get_repos_from_prisma_cloud(api_url, jwt_token):
    ...
    endpoint = "https://api3.prismacloud.io/code/api/v1/repositories"
...
# Login here with da token
jwt_token = login_to_prisma_cloud(API_URL, ACCESS_KEY, SECRET_KEY)
